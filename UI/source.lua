--https://raw.githubusercontent.com/GhostDuckyy/UI-Libraries/main/Coasting%20Ui%20Lib/source.lua
...
local Library = {
    Theme = {
        MainColor = library.theme.maincolor,
        BackgroundColor = library.theme.backgroundcolor,
        UIToggleKey = library.theme.uitogglekey,
        TextFont = library.theme.textfont,
        EasingStyle = library.theme.easingstyle
    },
    LibraryColorTable = {},
    TabCount = 0,
    FirstTab = nil,
