...
function Library:CreateWindow(windowname,windowinfo)
    ...
    function PageYep:addPage(pagename,scrollsize,visible,elementspacing)
        ...
        function PageElements:addLabel(labelname,labelinfo)
            ...
            LabelHolder.Size = UDim2.new(0, 288, 0, 33)
        ...
        function PageElements:addScript(Scriptname,Scriptinfo,script,Script) --推荐
            local ScriptHolder = Instance.new("Frame")
            local ScriptHolderCorner = Instance.new("UICorner")
            ...
            ScriptHolder.Parent = Home
            ScriptHolder.BackgroundColor3 = Color3.fromRGB(17, 17, 17)
            ScriptHolder.BorderColor3 = Color3.fromRGB(17, 17, 17)
            ScriptHolder.BorderSizePixel = 0
            ScriptHolder.Position = UDim2.new(0.0167785231, 0, 0, 0)
            ScriptHolder.Size = UDim2.new(0, 288, 0, 70)
            
            ScriptHolderCorner.CornerRadius = UDim.new(0, 5)
            ScriptHolderCorner.Name = "ScriptHolderCorner"
            ScriptHolderCorner.Parent = ScriptHolder
            
            ScriptTitle.Name = "ScriptTitle"
            ScriptTitle.Parent = ScriptHolder
            ScriptTitle.BackgroundColor3 = Color3.fromRGB(17, 17, 17)
            ScriptTitle.BackgroundTransparency = 1.000
            ScriptTitle.BorderColor3 = Color3.fromRGB(17, 17, 17)
            ScriptTitle.BorderSizePixel = 0
            ScriptTitle.Size = UDim2.new(0, 288, 0, 15)
            ScriptTitle.Font = Enum.Font.GothamSemibold
            ScriptTitle.Text = Scriptname or ""
            ScriptTitle.TextColor3 = Color3.fromRGB(255, 255, 255)
            ScriptTitle.TextSize = 12.000
            
            ScriptInfo.Name = "ScriptInfo"
            ScriptInfo.Parent = ScriptHolder
            ScriptInfo.BackgroundColor3 = Color3.fromRGB(17, 17, 17)
            ScriptInfo.BackgroundTransparency = 1.000
            ScriptInfo.BorderColor3 = Color3.fromRGB(17, 17, 17)
            ScriptInfo.BorderSizePixel = 0
            ScriptInfo.Position = UDim2.new(0, 0, 0.653846145, 0)
            ScriptInfo.Size = UDim2.new(0, 288, 0, 9)
            ScriptInfo.Font = Enum.Font.GothamSemibold
            ScriptInfo.Text = Scriptinfo or ""
            ScriptInfo.TextColor3 = Color3.fromRGB(255, 255, 255)
            ScriptInfo.TextSize = 11.000
            ScriptInfo.TextTransparency = 0.300
            
            ScriptButton.Name = "ScriptButton"
            ScriptButton.Parent = ScriptHolder
            ScriptButton.BackgroundColor3 = Color3.fromRGB(15, 15, 15)
            ScriptButton.BackgroundTransparency = 0
            ScriptButton.BorderColor3 = Color3.fromRGB(17, 17, 17)
            ScriptButton.BorderSizePixel = 0
            ScriptButton.Size = UDim2.new(0, 288, 0, 26)
            ScriptButton.AutoButtonColor = false
            ScriptButton.Font = Enum.Font.GothamSemibold
            ScriptButton.Text = "执行"
            ScriptButton.TextColor3 = Color3.fromRGB(255, 255, 255)
            ScriptButton.TextSize = 12
            ScriptButton.Position = UDim2.new(0, 0, 0.2, 0)
            
            ScriptCorner.CornerRadius = UDim.new(0, 5)
            ScriptCorner.Name = "ButtonCorner"
            ScriptCorner.Parent = ScriptButton
            
            ClipboardButton.Name = "ClipboardButton"
            ClipboardButton.Parent = ScriptHolder
            ClipboardButton.BackgroundColor3 = Color3.fromRGB(15, 15, 15)
            ClipboardButton.BackgroundTransparency = 0
            ClipboardButton.BorderColor3 = Color3.fromRGB(17, 17, 17)
            ClipboardButton.BorderSizePixel = 0
            ClipboardButton.Size = UDim2.new(0, 288, 0, 26)
            ClipboardButton.AutoButtonColor = false
            ClipboardButton.Font = Enum.Font.GothamSemibold
            ClipboardButton.Text = "复制"
            ClipboardButton.TextColor3 = Color3.fromRGB(255, 255, 255)
            ClipboardButton.TextSize = 12
            ClipboardButton.Position = UDim2.new(0, 0, 0.45, 0)
            
            ClipboardCorner.CornerRadius = UDim.new(0, 5)
            ClipboardCorner.Name = "ClipboardCorner"
            ClipboardCorner.Parent = ClipboardButton
            
            ClipboardButton.MouseButton1Down:Connect(function()
                setclipboard(script)
            end)
            ...
            TweenService:Create(ScriptButton,TweenInfo.new(.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{TextColor3 = Color3.fromRGB(137, 246, 255)}):Play()
            end)
            ...
            TweenService:Create(ScriptButton,TweenInfo.new(.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
            end)
            
            ClipboardButton.MouseEnter:Connect(function()
            TweenService:Create(
            ClipboardButton,
            TweenInfo.new(.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
            {TextSize = 15}
            ):Play()
            TweenService:Create(ClipboardButton,TweenInfo.new(.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{TextColor3 = Color3.fromRGB(137, 246, 255)}):Play()
            end)

            ClipboardButton.MouseLeave:Connect(function()
            TweenService:Create(
            ClipboardButton,
            TweenInfo.new(.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
            {TextSize = 12}
            ):Play()
            TweenService:Create(ClipboardButton,TweenInfo.new(.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
            end)
        end
        ...
        function PageElements:addButton(buttonname,callback)
            ...
            TweenService:Create(Button,TweenInfo.new(.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{TextColor3 = Color3.fromRGB(137, 246, 255)}):Play()
            end)
            ...
            TweenService:Create(Button,TweenInfo.new(.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
            end)
