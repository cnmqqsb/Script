...
function Library:CreateWindow(windowname,windowinfo)
    ...
    ui = false
    Frame.Visible = true
    Frame:TweenSize(UDim2.new(0, 0, 0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .6, true)
    DashBoard:TweenSize(UDim2.new(0, 0, 0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .6, true)
    TabContainer:TweenSize(UDim2.new(0, 0, 0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .6, true)
    PageContainer:TweenSize(UDim2.new(0, 0, 0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .6, true)
    else
    ui = true
    Frame.Visible = false
    Frame:TweenSize(UDim2.new(0, 432, 0, 285), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .6, true)
    DashBoard:TweenSize(UDim2.new(0, 107, 0, 223), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .6, true)
    TabContainer:TweenSize(UDim2.new(0, 100, 0, 214), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .6, true)
    PageContainer:TweenSize(UDim2.new(0, 299, 0, 223), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .6, true)
    end
    end)
