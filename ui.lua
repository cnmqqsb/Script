...
local redzlib = {
	...
	Save = {
		...
		TabSize = 160,
		Theme = "Darker",
		zuozhe = "sk jiaoben yuanming shark"
	},
	Settings = {},
	Connection = {},
	Instances = {},
...
function redzlib:MakeWindow(Configs)
	...
	SetProps(MainFrame, {
        Size = UDim2.fromOffset(0, 0), -- 初始大小为0
        BackgroundTransparency = 1 -- 初始透明度为1（完全透明）
    })
	...
	function Window:CloseBtn()
        ...
        AspectRatioConstraint.Parent = Main
        ...
        Title.Position = UDim2.new(0.5, 0, 0.50, 0)
        ...
        CreateTween({MainFrame, "Size", UDim2.fromOffset(0, 0), .4, true})
        CreateTween({SectionFrame, "Size", UDim2.fromOffset(0, 0), .4, true})
        CreateTween({TopBar, "Size", UDim2.fromOffset(0, 0), .4, true})
        wait(0.3)
        wait(0.5)
		ScreenGui:Destroy()
	...
	function Window:Dialog(Configs)
		...
		local Frame = Create("Frame", {
			Active = true,
			Size = UDim2.fromOffset(255 * 1.08, 150 * 1.08),
	...
	function Window:MakeTab(paste, Configs)
		...
		local Selected = InsertTheme(Create("Frame", TabSelect, {
			Size = FirstTab and UDim2.new(0, 6, 0, 4) or UDim2.new(0, 6, 0, 13),
    ...
    CreateTween({MainFrame, "Size", UDim2.fromOffset(UISizeX, UISizeY), 0.5, true})
    CreateTween({MainFrame, "BackgroundTransparency", 0, 0.5, true})	
